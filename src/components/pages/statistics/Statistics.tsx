  ...
  return (
    <div>
      ...
      <div className={styles.columns}>
       ...
       <h2 className={styles.header}>Многие посетители отмечают, что цены в некоторых местах неоправданно высоки, особенно если сравнивать их с качеством предоставляемых услуг. Однако есть и те, кто считает, что стоимость соответствует уровню сервиса.
